...
data=pd.read_csv('/home/tarun_acharya/Suraksha_files/extract.csv')
...
speak=result[0] 
print(speak)
row=['/home/tarun_acharya/Suraksha_files/output.wav',speak]
with open('/home/tarun_acharya/Suraksha_files/cfg/test_list.csv', 'a') as csvFile:
...
if __name__ == '__main__':
	get_id_result()
data=pd.read_csv('/home/tarun_acharya/Suraksha_files/res/results.csv')

with open('/home/tarun_acharya/Suraksha_files/cfg/test_list.csv','rt') as fh:
    mylist = []
    ...
    for row in myreader:
       mylist.append(row)
mylist = mylist[0:-1]
outref = open('/home/tarun_acharya/Suraksha_files/cfg/test_list.csv','w+')
