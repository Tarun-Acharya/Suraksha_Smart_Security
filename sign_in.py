...
class StartPage(tk.Frame):  
    ...
    def __init__(self, parent, controller):        
        ...
        self.image = Image.open("/home/tarun_acharya/Suraksha_files/2.png")
        ...
        label_var = Label(self, bg="white", font=("TkFixedFont",30),textvariable=txts)
...
# Designing popup for login success
        """
        button3 = tk.Button(self,bg="white", width=12, text="Submit",command=lambda:writeToFile(entry_1.get(), entry_2.get(), var.get(), entry_3.get(), entry_4.get()), font=("TkFixedFont", 25))
...
# Designing popup for login invalid password
    ...
    def password_not_recognised(self):
        ...
        self.sofiaResponse("Invalid password please reenter")
        #global b1
        if xyz>0:
            self.b1.destroy()                   
...
# Designing popup for user not found
    ...
    def user_not_found(self):
        ...
        self.sofiaResponse("User not found please reenter")
        #global b1
        if xyz>0:
            self.b1.destroy()
        #l1.pack_forget()      
        
        #Button(self, text="OK", command=self.delete_user_not_found_screen).pack()
