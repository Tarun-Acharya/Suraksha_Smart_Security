...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.image = Image.open("/home/tarun_acharya/Suraksha_files/pic.jpg")
        ...
        def writeToFile(a,b,c,d,e):
            ...
            global check
            check=0
            df=pd.read_csv("/home/tarun_acharya/Suraksha_files/database.csv")
            ...
            if(a!="NULL" and b!="NULL" and c!="NULL" and d!="NULL" and e!="NULL" and flag==2 and check==0):
                ...
                df.to_csv("/home/tarun_acharya/Suraksha_files/database.csv",encoding='utf-8',index=False)
                ...
                engine.say('Please enter all the details')
                engine.runAndWait()
                engine.stop()
        def selectimage():
            global flag
            ...
            while True:
                ...
                #ret,frame = video_capture.read()
                    ...
                    path='/home/tarun_acharya/Suraksha_files/input_images/'  #give the path name here
                    b=entry_2.get()
        ...
        def selectaudio():
            ...
            engine.runAndWait()
            engine.stop()
            WAVE_OUTPUT_FILENAME ="/home/tarun_acharya/Suraksha_files/data/wav/enroll/"+x+".wav"
            p = pyaudio.PyAudio()
            ...
            row=['/home/tarun_acharya/Suraksha_files/data/wav/enroll/'+x+'.wav',int(contents)]
            with open('/home/tarun_acharya/Suraksha_files/cfg/enroll_list.csv', 'a') as csvFile:
